...
def process_frame(frame):
    global white_counter, white_state, previous_white_state, no_white_frames
    global yellow_counter, yellow_state, previous_yellow_state, no_yellow_frames
    global is_mouth_detected, prev_mouth_rect
...
while True:
    ...
    if frame_index % 2 == 1:
        ...
        # 프레임 처리 함수를 멀티스레드로 실행
        thread_white = threading.Thread(target=process_frame, args=(frame.copy(),))
        thread_yellow = threading.Thread(target=process_frame, args=(frame.copy(),))
